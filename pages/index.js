...
// It uses React and inline JSX for structure, which is standard for Next.js/Vercel.

export default function HomePage() {
  // The entire page is returned as a single block of JSX.
  // Note the use of `dangerouslySetInnerHTML` for the <style> and <script> tags.
  // This is a standard way to include non-JSX-managed CSS and JS in a Next.js page component.
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <title>📞 BD Number Lookup - Get Operator & Name Info</title>
      <meta name="description" content="A fast, free, and open-source tool to look up information about any Bangladeshi mobile number. Find the operator, location, and registered name instantly.">
      ...
      <meta property="og:url" content="https://bd-num-lookup.vercel.app/"> 
      <meta property="og:title" content="📞 BD Number Lookup - Get Operator & Name Info">
      ...
      <meta property="og:image" content="https://emoji.gg/assets/emoji/9095-phone.png">

      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="https://bd-num-lookup.vercel.app/">
      <meta property="twitter:title" content="📞 BD Number Lookup - Get Operator & Name Info">
      ...
      <meta property="twitter:image" content="https://emoji.gg/assets/emoji/9095-phone.png">
      ...
      <style>
        ...
        @keyframes pulse {
          0% { transform: scale(1); text-shadow: 0 0 10px rgba(88, 166, 255, 0.3); }
          50% { transform: scale(1.03); text-shadow: 0 0 20px rgba(88, 166, 255, 0.5); }
          100% { transform: scale(1); text-shadow: 0 0 10px rgba(88, 166, 255, 0.3); }
        }
        ...
        #whatsappBtn:hover { background: #128C7E; }

        #telegramBtn { background: #0088cc; color: #fff; border-color: #0088cc;}
        #telegramBtn:hover { background: #0077b5; }
        ...
        .developer-credit a {
            font-weight: 600;
            background: linear-gradient(90deg, #ff8a00, #e52e71, #4c5fd7, #2de2e6);
        ...
        .url { font-family: 'Menlo', 'Courier New', monospace; color: var(--text-primary); }
        .params { list-style: none; padding: 0; }
        .params li { margin-bottom: 10px; font-size: 0.95em; }
        .param-name { font-weight: bold; color: #58a6ff; }
        .param-type { font-style: italic; color: #a5d6ff; margin: 0 10px; }
        .required, .optional { padding: 2px 6px; border-radius: 3px; font-size: 0.8em; }
        .required { background: #da3633; color: white; }
        .optional { background: #30363d; color: #c9d1d9; }
      ...
      <div class="container">
        ...
        <div class="api-docs-container">
          ...
          <div id="apiDocsWrapper">
              ...
              <ul class="params">
                  <li><span class="param-name">number</span> <span class="param-type">string</span> <span class="required">Required</span> - The 11-digit Bangladeshi mobile number (e.g., 01712345678).</li>
                  <li><span class="param-name">raw</span> <span class="param-type">string</span> <span class="optional">Optional</span> - Set to "true" to get the full, unprocessed JSON response from the external provider.</li>
              </ul>

              <h4>Example: Javascript Fetch</h4>
              <pre><code class="language-js">
fetch('https://YOUR_DOMAIN/api/lookup?number=01712345678')
              ...
              <pre><code class="language-json">
{
  ...
  "location": "Bangladesh",
  "type": "mobile",
  "timestamp": "2025-06-24T00:16:00.123Z",
  "developer": "GAJARBOTOL"
      ...
      <script>
        // Store the last successful result text for download
        let lastResultText = "";

        // Helper to create a result line, preventing XSS with textContent
        ...
        async function lookup() {
          ...
          lastResultText = ""; // Clear previous result

          // Basic frontend validation
          if (!/^01[3-9]\\d{8}$/.test(num)) {
            resultDiv.innerHTML = '<span class="error-message">❌ Invalid number format. Use 01XXXXXXXXX.</span>';
            return;
          }
          ...
          try {
            ...
            if (data.success) {
              ...
              // Show all action buttons with the slide-up animation
            ...
            resultDiv.classList.add('fade-in');
            resultDiv.innerHTML = '<span class="error-message">❌ Error fetching data. Check your connection and try again.</span>';
          }
        }

        function downloadResult() {
          if (!lastResultText) {
            // In a real app, you might use a styled modal instead of alert
